...
# print_menu is a method to be called later when we print the user's choice menu.
...
# menu_choice is how the user makes a choice. I really wanted to make this a function, but it wouldn't behave itself.

...
class Grid(Deck):
        ...
        def fill(self):
            # fill the grid with unique cards
            self.array = []
        ...
        def cardCompare(self, i, n):
            # get the images on the main card, the card to its right, and the card beneath it,
            # using getCard to find the card at position i, n and strip out the directionality
            main = self.getCard(i, n)
            right = self.getCard(i+1, n)
            beneath = self.getCard(i, n+1)

            # change those images from lists to tuples
            main = tuple(main[0])
            right = tuple(right[0])
...
print grid.getCard(0, 1)
print grid.getCard(0, 2)
print grid.getCard(0, 3)
print grid.getCard(0, 4)
print grid.getCard(1, 0)
print grid.getCard(1, 1)
print grid.getCard(1, 2)
print grid.getCard(1, 3)
print grid.getCard(1, 4)
print grid.getCard(2, 0)
print grid.getCard(2, 1)
print grid.getCard(2, 2)
print grid.getCard(2, 3)
print grid.getCard(2, 4)

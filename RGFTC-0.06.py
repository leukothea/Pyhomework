...
# First, we define 25 custom cards objects with 25 tuples, each composed of four picturehalves. 
...
e = ("Ship", "Bridge", "Knot", "Bouquet")
f = ("Ship", "Mice", "Horse", "Firewood")
g = ("House", "Ring", "Heron", "Apple")
h = ("House", "Crayfish", "Scales", "Fish")
j = ("Firewood", "Demons", "Fox", "Forest")
k = ("Apple", "Sun", "Angel", "Horseshoe")
l = ("Snake", "Branches", "Scythe", "Mountains")
m = ("Snake", "Knot", "Angel", "Book")
n = ("Hearse", "Lady", "Bear", "Moon")
o = ("Bouquet", "Mountains", "Letter", "Money")
p = ("Scythe", "Birds", "Ring", "Anchor")
q = ("Boy", "Road", "Sun", "Dog")
r = ("Boy", "Rooster", "Demons", "Bread")
s = ("Fox", "Heart", "Owl", "Scales")
t = ("Bear", "Mice", "Money", "Fire")
u = ("Stars", "Book", "Road", "Dagger")
v = ("Heron", "Handshake", "Lily", "Dog")
w = ("Forest", "Crayfish", "Horseshoe", "Bridge")
x = ("Heart", "Rooster", "Lily", "Cat")
y = ("Letter", "Anchor", "Fish", "Pig")
z = ("Lady", "Dagger", "Bread", "Horse")

# Then we make a deck of all those cards. 
...
# Next, we make a 5x5 grid to hold the card objects. Fill, shuffle, print. 

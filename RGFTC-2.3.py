...
class Grid(Deck):
        ...
        def cardCompare(self, i, n ):
            ...
            # for main cards in row 4, find only the card to the right
            ...
            # for main cards in column 4, find only the card beneath
...
#Randomly assign an arrow direction to each match and return the list as "readings"
...
for line in readings:
    lookup = (line)
    print lookup + " : " + Meaning.get(lookup)

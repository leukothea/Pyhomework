...
# Directionality must be coded into each picturehalves, because there is no rhyme nor reason to it.
# Each picturehalves also contains either "clock" for clockwise, or "widdershins" for widdershins (counterclockwise).
